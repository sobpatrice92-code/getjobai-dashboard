...
def inject_aiapply_light():
    ...
    /* ---------- Hero clair AUTONOME (inject_animations retiré) ---------- */
    .holo-hero{ position:relative; overflow:hidden; padding:2rem 2.2rem; margin:.4rem 0 1.6rem;
      border-radius:18px;
      background:linear-gradient(120deg,#EEF4FF 0%, #E9F7F3 100%) !important;
    ...
    .holo-hero h1{ margin:0 !important; color:#111827 !important; -webkit-text-fill-color:#111827 !important;
      background:none !important; font-family:'Poppins','Inter',sans-serif; font-size:1.9rem !important;
      font-weight:700 !important; letter-spacing:-.5px !important; line-height:1.15 !important; }
    .holo-hero p{ margin:.5rem 0 0 !important; color:#5B6678 !important; font-size:1rem !important; }
    .holo-dot{ display:inline-block; width:10px; height:10px; border-radius:50%; margin-right:10px;
      vertical-align:middle; background:#2F6BFF !important; box-shadow:0 0 10px rgba(47,107,255,.5) !important; }
    </style>
    """, unsafe_allow_html=True)
