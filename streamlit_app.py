...
""")
    ...
    with tab9:
        ...
        st.info("ℹ️ **Comment ça marche** : sur une offre LinkedIn, cliquez « Easy Apply », puis le "
                "bouton **📝 Remplir (GetJobAI)** de l'extension → le formulaire se remplit "
                "automatiquement. Vous vérifiez et **soumettez vous-même** (aucun risque).")
